...
class DialogModel extends StatefulWidget {
  final String passengerName,passengerEmail,phoneNumber,date,time,from,to,cost,bookingType;
...
class InvoiceDataModal extends ModalRoute<bool> {

  String passengerName,passengerEmail,phoneNumber,date,time,from,to,cost,bookingType;
