...
class DialogModel extends StatefulWidget {
  ...
  final String passengerName,passengerEmail,phoneNumber,date,time,city,hours,cost,bookingType;

  final bool isBusinessCheck;
  final invoiceNumber;
            ...
            [
              ...
              Screenshot(
                ...
                child: FlutterTicketWidget(
                  width: 350.0,
                  height: widget.isBusinessCheck ? 1010.0 : 1150,
                                ...
                                child: Row(
                                  ...
                                  [
                                    Container(
                                      ...
                                      height:50,
                                      width: 140,
                                      child: Text('City : ${widget.city}',maxLines: 6,overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 13, color: Colors.black,fontWeight: FontWeight.w500),),
                                    ),
                                    SizedBox(width: 35,),
                                    Container(
                                      //color: Colors.green,
                                      height:50,
                                      width: 105,
                                      child: Text('Hours : ${widget.hours}',maxLines: 6,overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 13, color: Colors.black,fontWeight: FontWeight.w500),),
                                    ),
                                  ],
                                ),
                              ),
...
class HourlyTransferInvoiceDataModal extends ModalRoute<bool> {

  String passengerName,passengerEmail,phoneNumber,date,time,city,hours,cost,bookingType;
  bool isBusinessCheck;
  var invoiceNumber;
  String businessName,businessContact,billingAddress,state,country,businessPhone,businessEmail;

  HourlyTransferInvoiceDataModal({
    @required this.passengerName,
    @required this.passengerEmail,
    @required this.phoneNumber,
    @required this.date,
