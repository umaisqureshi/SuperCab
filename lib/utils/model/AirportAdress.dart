...
AirportAddress airportAddressFromJson(str) => AirportAddress.fromJson(str);
...
class AirportAddress {
  ...
  factory AirportAddress.fromJson(Map<String, dynamic> json) => AirportAddress(
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
    ...
    postcodeLocalities: json["postcode_localities"] == null ? null : List<String>.from(json["postcode_localities"].map((x) => x)),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "postcode_localities": postcodeLocalities == null ? null : List<dynamic>.from(postcodeLocalities.map((x) => x)),
  };
}
...
enum Type { STREET_NUMBER, ROUTE, LOCALITY, POLITICAL, ADMINISTRATIVE_AREA_LEVEL_2, ADMINISTRATIVE_AREA_LEVEL_1, COUNTRY, POSTAL_CODE, PLUS_CODE }
