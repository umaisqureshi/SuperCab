...
class NotificationDetails_LocalTransfer extends StatefulWidget {
  ...
  NotificationDetails_LocalTransfer({
  ...
  @override
  _NotificationDetails_LocalTransferState createState() => _NotificationDetails_LocalTransferState();
}

class _NotificationDetails_LocalTransferState extends State<NotificationDetails_LocalTransfer> {
